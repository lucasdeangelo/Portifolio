  ...
  return (
    <main>
      ...
      <div className="hero">
        <div>
          <div className="ml-36">
            ...
            <p className='text-preto text-lg pl-60 pt-4'>Sou um Desenvolvedor Full Stack com foco <br /> em UX Design. Me conheça melhor a partir do <br /> conteúdo sobre mim que eu preparei <br /> especialmente para você!</p>
      ...
      <div className="sobremim">
        <div>          
            <h2 className='text-5xl text-preto text-center font-extrabold relative bottom-30'>Sobre Mim</h2>
            ...
            <p className='relative text-preto left-[30%] bottom-[740px]'>Me chamo Lucas, tenho 18 anos, moro em <br /> Embu das Artes e sou um grande entusiasta <br /> da tecnologia desde criança e como destino, <br /> segui carreira nessa área.</p>

            <p className='relative text-preto left-[53%] bottom-[640px]'>Como me apresentei antes, trabalho com o <br /> desenvolvimento completo de aplicações <br /> diversas, com experiência em Web Design em <br /> HTML, CSS, React, Tailwind, Wordpress, UX e Design em Geral.</p>

            <p className='relative text-preto left-[30%] bottom-[470px]'>Tenho como principal foco trazer soluções <br /> práticas no mundo real que façam a diferença <br /> de verdade na vida das pessoas, desde a <br /> segurança, UX e fucionalidade diante aos <br /> problemas existentes. </p>
      ...
      <div className="skills">
        <div>
          <h2 className='text-5xl text-preto text-center font-extrabold relative bottom-30'>Skills</h2>
          <div className="cards">
            <div className="card1">
              <div className='bg-white shadow-xl flex-collumn gap-[35px] w-[300px] h-[300px] p-5 rounded-2xl relative left-[450px] top-[100px]'>
                ...
                <h3 className='relative text-preto left-[60px] bottom-[40px] pt-3 text-2xl font-bold'>Design</h3>
                <div className='relative text-preto left-[60px] bottom-[35px]'>
                  <p>UX & UI</p>
                  <p>Figma</p>
                  <p>Pacote Adobe</p>
                  <p>Copywritting</p>
          ...
          <div className="cards">
            <div className="card2">
              <div className='bg-white shadow-xl flex-collumn gap-[35px] w-[300px] h-[300px] p-5 rounded-2xl relative left-[800px] bottom-[200px]'>
                ...
                <h3 className='relative text-preto left-[60px] bottom-[40px] pt-3 text-2xl font-bold'>Front End</h3>
                <div className='relative text-preto left-[60px] bottom-[35px]'>
          ...
          <div className="cards">
            <div className="card3">
              <div className='bg-white shadow-xl flex-collumn gap-[35px] w-[300px] h-[300px] p-5 rounded-2xl relative left-[1150px] bottom-[500px]'>
                ...
                <h3 className='relative text-preto left-[60px] bottom-[40px] pt-5 text-2xl font-bold'>Back End</h3>
                <div className='relative text-preto left-[60px] bottom-[35px]'>
                  <p>Lógica</p>
                  <p>Python</p>
                  <p>NodeJS</p>
          ...
          <div className="cards">
            <div className="card4">
              <div className='bg-white shadow-xl flex-collumn gap-[35px] w-[300px] h-[300px] p-5 rounded-2xl relative left-[630px] bottom-[460px]'>
                ...
                <h3 className='relative text-preto left-[60px] bottom-[40px] pt-3 text-2xl font-bold'>Cybersecurity</h3>
                <div className='relative text-preto left-[60px] bottom-[35px]'>
                  <p>SOC</p>
                  <p>Pentesting</p>
                  <p>Risk Analisis</p>
          ...
          <div className="cards">
            <div className="card5">
              <div className='bg-white shadow-xl flex-collumn gap-[35px] w-[300px] h-[300px] p-5 rounded-2xl relative left-[980px] bottom-[760px]'>
                ...
                <h3 className='relative text-preto left-[60px] bottom-[40px] pt-3 text-2xl font-bold'>Inglês</h3>
                <div className='relative text-preto left-[60px] bottom-[35px]'>
      ...
      <div className="qualificacao">
        <div>
          <div className="relative bottom-[320px]">
            <h2 className='text-5xl text-preto text-center font-extrabold relative bottom-30'>Qualificações</h2>
            <div className="flex justify-center items-center pt-[150px]">
            ...
            <div className='item1'>
              <h4 className='relative text-preto left-[30%] bottom-[840px] font-medium text-2xl pb-2'>Ensino Médio</h4>
              <p className='relative text-preto left-[30%] bottom-[840px]'>Escola Estadual Maria Auxiliadora</p>
              <Image className='relative left-[30%] bottom-[830px]' src={"/../public/icons/book.png"} width={20} height={20} alt=''/>
              <p className='relative text-preto left-[31.5%] bottom-[852px]'>2020 - 2022</p>
            </div>

            <div className="item2">
              <h4 className='relative text-preto left-[53%] bottom-[830px] font-medium text-2xl pb-2'>Desenvolvimento de Sistemas</h4>
              <p className='relative text-preto left-[53%] bottom-[830px]'>Etec de Embu</p>
              <Image className='relative left-[53%] bottom-[820px]' src={"/../public/icons/book.png"} width={20} height={20} alt=''/>
              <p className='relative text-preto left-[54.5%] bottom-[843px]'>2022 - 2023</p>
            </div>

            <div className="item4">
              <h4 className='relative text-preto left-[30%] bottom-[810px] font-medium text-2xl pb-2'>Curso de Inglês</h4>
              <p className='relative text-preto left-[30%] bottom-[810px]'>Enjoy Cursos Profissionalizantes</p>
              <Image className='relative left-[30%] bottom-[800px]' src={"/../public/icons/book.png"} width={20} height={20} alt=''/>
              <p className='relative text-preto left-[31.5%] bottom-[822px]'>2022 - 2024</p>
            </div>

            <div className="item5">
              <h4 className='relative text-preto left-[53%] bottom-[790px] font-medium text-2xl pb-2'>Treinamento de Marketing</h4>
              <p className='relative text-preto left-[53%] bottom-[790px]'>V4 Company</p>
              <Image className='relative left-[53%] bottom-[780px]' src={"/../public/icons/book.png"} width={20} height={20} alt=''/>
              <p className='relative text-preto left-[54.5%] bottom-[803px]'>2023 - 2024</p>
            </div>

            <div className="item6">
              <h4 className='relative text-preto left-[30%] bottom-[760px] font-medium text-2xl pb-2'>Design Digital</h4>
              <p className='relative text-preto left-[30%] bottom-[760px]'>FIAP</p>
              <Image className='relative left-[30%] bottom-[750px]' src={"/../public/icons/book.png"} width={20} height={20} alt=''/>
              <p className='relative text-preto left-[31.5%] bottom-[772px]'>2024 - 2026</p>
            </div>         
          </div>
        </div>
      </div>
      ...
      <div className='trabalhos'>
        <div>
          <h2 className='text-5xl text-preto text-left ml-[58vh] font-extrabold relative bottom-[65vh]'>Trabalhos</h2>
          <p className='text-preto relative bottom-[63vh] ml-[59vh] text-xl'>Trabalhos que já fiz ao longo dos<br />3 anos de experiência em design.</p>
          <div>
            <CCarousel controls transition="crossfade">
              <CCarouselItem>
                <CImage className="d-block w-100" src='/../public/image/adoracao.png' alt="slide 1" />
              </CCarouselItem>
              <CCarouselItem>
                <CImage className="d-block w-100" src='/../public/image/amem_producoes.png' alt="slide 2" />
              </CCarouselItem>
              <CCarouselItem>
                <CImage className="d-block w-100" src='/../public/image/gohan_sushi_bar.png' alt="slide 3" />
              </CCarouselItem>
              <CCarouselItem>
                <CImage className="d-block w-100" src='/../public/image/SafeInventory.png' alt="slide 4" />
              </CCarouselItem>
              <CCarouselItem>
                <CImage className="d-block w-100" src='/../public/image/social_media.png' alt="slide 5" />
              </CCarouselItem>
            </CCarousel>
          </div>
        </div>
